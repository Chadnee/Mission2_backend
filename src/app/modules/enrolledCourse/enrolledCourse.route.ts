...
router.post('/student-enrollment-stats/generate',EnrolledCourseControllers.generateStudentEnrollmentStats)
...
router.get('/student-enrollment-stats',EnrolledCourseControllers.getTotalEnrolledCoursePerStudent)
